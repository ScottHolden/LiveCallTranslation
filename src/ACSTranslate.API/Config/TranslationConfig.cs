...
)
{
    ...
    private static readonly LanguageConfig[] _languages = [
        ...
        new LanguageConfig(
            ...
            "hi-IN",
            "hi-IN-SwaraNeural",
            "नमस्ते, मैं एक एआई अनुवादक हूँ जो आज कॉल में सहायता करेगा। आप पूरे संवाद के दौरान मेरी आवाज़ और एजेंट की आवाज़ दोनों सुनेंगे। कृपया प्रतीक्षा करें जबकि हम आपको एक एजेंट से जोड़ते हैं।",
            "आप अब जुड़े हुए हैं।"
        ),
        new LanguageConfig(
            "Italian",
        ...
        new LanguageConfig(
            ...
            "ja-JP",
            "ja-JP-KeitaNeural",
            "こんにちは、私は今日の通話を支援するAI翻訳者です。会話中は私の声とエージェントの声の両方が聞こえます。エージェントに接続するまでお待ちください。",
            "接続されました。"
        ),
        new LanguageConfig(
            "Korean",
            "ko-KR",
            "ko-KR-SunHiNeural",
            "안녕하세요, 저는 오늘 통화에 도움을 줄 AI 번역기입니다. 대화 내내 제 목소리와 상담원의 목소리를 모두 들으실 수 있습니다. 상담원과 연결하는 동안 기다려 주세요.",
            "지금 연결되었습니다."
        ),
        new LanguageConfig(
            "Portuguese (Brazil)",
